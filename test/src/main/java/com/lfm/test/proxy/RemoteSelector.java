...
public class RemoteSelector implements Runnable {
    ...
    //这就导致了，响应一直到不了。
    private ConcurrentLinkedQueue<ChannelBridge> waitRegisterBridges = new ConcurrentLinkedQueue<>();
    ...
    private void listen() {
        ...
        while (true) {
            try {
                //注册remoteChannal
                ChannelBridge waitRegisterBridge;
    ...
    public void addWaitRegistBridge(ChannelBridge channalBridge) {
